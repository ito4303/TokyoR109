...
[b](https://mc-stan.org/users/interfaces/bayesplot)[ayesplot](http://mc-stan.org/bayesplot/)パッケージに、事後予測検査 (Posterior predictive check) のための関数ひとつとしてRootogramが実装されている。
